...
bool SBFAsmPrinter::doInitialization(Module &M) {
  ...
  // Unsupported for CBE: https://github.com/Cartallum/llvm-project/issues/37
  if (MAI->doesSupportDebugInformation() && !M.debug_compile_units().empty() &&
      !TM.getMCSubtargetInfo()->hasFeature(SBF::FeatureCBE) && TM.getTargetTriple().getArch() != Triple::sbf) {
