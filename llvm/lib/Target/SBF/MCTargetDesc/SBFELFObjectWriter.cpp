...
public:
  SBFELFObjectWriter(uint8_t OSABI, bool isCBE, bool relocAbs64);
...
SBFELFObjectWriter::SBFELFObjectWriter(uint8_t OSABI, bool isCBE,
                                       bool relocAbs64)
    : MCELFObjectTargetWriter(/*Is64Bit*/ true, OSABI, ELF::EM_SBF,
                              /*HasRelocationAddend*/ false),
      isCBE(isCBE), relocAbs64(relocAbs64) {}
...
unsigned SBFELFObjectWriter::getRelocType(MCContext &Ctx, const MCValue &Target,
  ...
  case FK_Data_8:
    return (isCBE && !relocAbs64) ? ELF::R_SBF_64_64 : ELF::R_SBF_64_ABS64;
  case FK_Data_4:
    ...
    return isCBE ? ELF::R_SBF_64_32 : ELF::R_SBF_64_ABS32;
  }
}

std::unique_ptr<MCObjectTargetWriter>
llvm::createSBFELFObjectWriter(uint8_t OSABI, bool isCBE, bool useRelocAbs64) {
  return std::make_unique<SBFELFObjectWriter>(OSABI, isCBE, useRelocAbs64);
}
