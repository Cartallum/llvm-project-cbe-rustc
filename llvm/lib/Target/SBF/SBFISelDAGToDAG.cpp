//===-- SBFISelDAGToDAG.cpp - A dag to dag inst selector for SBF ----------===//
//
...
//===----------------------------------------------------------------------===//
//
// This file defines a DAG pattern matching instruction selector for SBF,
// converting from a legalized dag to a SBF dag.
//
//===----------------------------------------------------------------------===//
...
class SBFDAGToDAGISel : public SelectionDAGISel {

  /// Subtarget - Keep a pointer to the SBFSubtarget around so that we can
...
// ComplexPattern used on SBF FI instruction
bool SBFDAGToDAGISel::SelectFIAddr(SDValue Addr, SDValue &Base,
                                   SDValue &Offset) {
  SDLoc DL(Addr);
...
void SBFDAGToDAGISel::Select(SDNode *Node) {
...
void SBFDAGToDAGISel::PreprocessLoad(SDNode *Node,
...
void SBFDAGToDAGISel::PreprocessISelDAG() {
...
bool SBFDAGToDAGISel::getConstantFieldValue(const GlobalAddressSDNode *Node,
...
bool SBFDAGToDAGISel::fillGenericConstant(const DataLayout &DL,
                                          const Constant *CV,
                                          val_vec_type &Vals, uint64_t Offset) {
...
bool SBFDAGToDAGISel::fillConstantDataArray(const DataLayout &DL,
...
bool SBFDAGToDAGISel::fillConstantArray(const DataLayout &DL,
...
bool SBFDAGToDAGISel::fillConstantStruct(const DataLayout &DL,
