...
public:
  BPFELFObjectWriter(uint8_t OSABI, bool isCBE, bool relocAbs64);
...
BPFELFObjectWriter::BPFELFObjectWriter(uint8_t OSABI, bool isCBE,
                                       bool relocAbs64)
...
unsigned BPFELFObjectWriter::getRelocType(MCContext &Ctx, const MCValue &Target,
  ...
  case FK_Data_8:
    return (isCBE && !relocAbs64) ? ELF::R_BPF_64_64 : ELF::R_BPF_64_ABS64;
  case FK_Data_4:
    ...
    return isCBE ? ELF::R_BPF_64_32 : ELF::R_BPF_64_ABS32;
  }
}

std::unique_ptr<MCObjectTargetWriter>
llvm::createBPFELFObjectWriter(uint8_t OSABI, bool isCBE, bool useRelocAbs64) {
  return std::make_unique<BPFELFObjectWriter>(OSABI, isCBE, useRelocAbs64);
}
